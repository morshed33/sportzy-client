...
// ToastProvider to wrap around your app
const ToastProvider = ToastPrimitives.Provider;

// Toast viewport, where toasts will appear
...
// ToastAction component for actions like "Undo"
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors hover:bg-secondary focus:outline-none focus:ring-1 focus:ring-ring disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-muted/40 group-[.destructive]:hover:border-red-500 group-[.destructive]:hover:bg-red-600 group-[.destructive]:hover:text-white",
      className
    )}
    {...props}
  />
...
// ToastClose component for closing the toast
...
// ToastTitle component for the title of the toast
...
// ToastDescription component for additional details in the toast
...
// Define the ToastActionElement type for actions within toasts
